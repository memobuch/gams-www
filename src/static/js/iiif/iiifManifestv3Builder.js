...
const IIIFManifestBuilder = (
    ...
    const build = async (projectAbbr, objectId) => {
        ...
        let url = `${GAMS_API_ORIGIN}/api/curation/v1/projects/memor/objects/${objectId}/datastreams`;
        ...
        const template = {
            ...
            "id": `${gamsProductionOrigin}/api/curation/v1/projects/memor/objects/memor.person.100/datastreams/manifest.json/content`,
            "type": "Manifest",
            "label": {
                "de": [
                "Personen material"
